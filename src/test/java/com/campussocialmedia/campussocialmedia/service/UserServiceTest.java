...
// assertTrue(new
// ReflectionEquals(userDTO).matches(userservice.getUserByUserName("ABC")));
// }
...
// // PersonalDetails details = new PersonalDetails("-", new
// ArrayList<String>(),
...
// // assertTrue(new
// // ReflectionEquals(expectedDTO).matches(userservice.addUser(userDTO)));
// // }

// @Test
// public void getUserAboutByUserNameTest() {
// College college = new College("First", "DEP", "Btech");
// UserAbout userAbout = new UserAbout("A", "email", "password", "firstName",
// "lastName", college);
...
// user.setPersonalChats(emptyList);
// user.setGroups(emptyList);
// PersonalDetails details = new PersonalDetails("-", new ArrayList<String>(),
// new ArrayList<String>());
// user.setPersonalDetails(details);
// user.setFollowers(new ArrayList<String>());
// user.setFollowing(new ArrayList<String>());
...
// // assertTrue(new
// //
// ReflectionEquals(userAbout).matches(userservice.getUserAboutByUserName("A")));
...
// PersonalDetails details = new PersonalDetails("-", new ArrayList<String>(),
// new ArrayList<String>());
// // UserAbout userAbout = new UserAbout("A", "email", "password",
// // "firstName","lastName",
// // college);
// // userAbout.setPersonalDetails(details);
// // userAbout.setBio("-");
...
// Mockito.when(repository.findUserByUserName("A")).thenReturn(user);
// assertEquals(userFollowerFollowing,
// userservice.getUserFollowerFollowingByUserName("A"));
